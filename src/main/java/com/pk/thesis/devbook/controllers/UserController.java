...
public class UserController {
    ...
    public ResponseEntity<FullUserDTO> inviteFriend(@RequestBody InvitationToFriendsListRequest request) {
        return ResponseEntity.ok(userService.inviteFriend(request));
    }

    @PostMapping("/invitations/accept")
    public ResponseEntity<FullUserDTO> acceptUserInvitationToFriends(@RequestBody InvitationToFriendsListRequest request){
