...
import com.pk.thesis.devbook.payload.response.MessageResponse;
import com.pk.thesis.devbook.repository.RoleRepository;
import com.pk.thesis.devbook.repository.UserRepository;
import com.pk.thesis.devbook.security.jwt.JwtUtils;
import com.pk.thesis.devbook.security.services.UserDetailsImpl;
...
public class AuthController {
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
		...
		//TODO: zmienic tutaj zeby uzytkownik mial odrazu role user 
		if (strRoles == null) {
